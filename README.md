...
![](images/GuitarRoom_GuitarRoomArea2_Angle_009.jpg)

## Room Replica Model Pictures
<details>
  <summary>📸 Click to view project screenshots</summary>
  <br>
  <img src="images/GuitarRoom_GuitarRoomArea1_Angle_008.jpg" width="100%">
  <img src="images/GuitarRoom_GuitarRoomArea3_Angle_010.jpg" width="100%">
  <img src="images/GuitarRoom_Guitar_Angle_003.jpg" width="100%">
  <img src="images/GuitarRoom_Camera_Angle_001.jpg" width="100%">
  <img src="images/GuitarRoom_FernWithChairs_Angle_002.jpg" width="100%">
  <img src="images/GuitarRoom_GuitarCorner_Angle_006.jpg" width="100%">
  <img src="images/GuitarRoom_OtherRoom2_Angle_007.jpg" width="100%">
  <img src="images/GuitarRoom_OtherRoom_Angle_005.jpg" width="100%">
  <img src="images/GuitarRoom_Shelf_Angle_004.jpg" width="100%">
</details>
...
I became comfortable using Maya's transformation tools—including moving, rotating, and scaling objects—to build accurate models while maintaining proper proportions throughout the scene. Working directly with vertices, edges, and faces gave me a better understanding of how geometry is constructed and refined. <br>

As the project progressed, I learned the importance of clean topology by creating efficient polygon layouts, minimizing unnecessary geometry, and primarily using quad-based meshes. This helped me understand how topology affects both model quality and future editing. <br>

Beyond modeling, I learned the complete workflow for preparing assets by creating UV maps, applying textures and materials, and using normal maps to add realistic surface detail without increasing polygon count. <br>
